    ...
    <div class="card-body">
        <form action="{{ route("admin.products.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                <label for="name">{{ trans('global.product.fields.code') }}*</label>
            ...
            <div class="form-group {{ $errors->has('count') ? 'has-error' : '' }}">
                <label for="name">{{ trans('global.product.fields.count') }}*</label>
                <input type="text" id="cont" name="count" class="form-control" value="{{ old('count', isset($product) ? $product->count : '') }}">
                @if($errors->has('count'))
                    <em class="invalid-feedback">
                        {{ $errors->first('count') }}
                    </em>
